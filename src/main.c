        ...
        if (j == shape_serial_number) {
            ...
            for (i = 1; i < serial_number; i++) {
                ...
                if (i == shape_serial_number2) {
                    if (distance_between_points(geo->circle[number_circle2].point, geo->circle[number_circle].point)
                        > (geo->circle[number_circle2].radius + geo->circle[number_circle].radius)) {
                        number_circle2++;
                        continue;
                    }
                    while (1) {
                ...
                if (i == shape_serial_number2) {
                    for (int qwe = 0; qwe < 3; qwe++) {
                        for (int qwert = 0; qwert < 3; qwert++) {
                            ...
                            ad = distance_between_points(
                                    geo->triangle[number_triangle2].point[qwe + 1], geo->triangle[number_triangle].point[qwert + 1]);
                            ...
                            br = distance_between_points(
                                    geo->triangle[number_triangle].point[qwert], geo->triangle[number_triangle].point[qwert + 1]);

                            bc = distance_between_points(geo->triangle[number_triangle].point[qwert + 1], geo->triangle[number_triangle2].point[qwe]);
                            bd = distance_between_points(
                                    geo->triangle[number_triangle].point[qwert + 1], geo->triangle[number_triangle2].point[qwe + 1]);
                ...
                if (i == shape_serial_number2) {
                    ...
                    for (int qwert = 0; qwert < 3; qwert++) {
                        for (int qwe = 0; qwe < size2; qwe++) {
                            ...
                            ad = distance_between_points(
                                    geo->poligon[number_poligon2].points[qwe + 1], geo->triangle[number_triangle].point[qwert + 1]);
                            ...
                            bd = distance_between_points(
                                    geo->triangle[number_triangle].point[qwert + 1], geo->poligon[number_poligon2].points[qwe + 1]);
                            if (!((aa < ar && ab < ar && ac < ar && ad < ar) || (ba < br && bb < br && bc < br && bd < br))) {
                                error++;
                            }
                        }
                ...
                if (i == shape_serial_number2) {
                    ...
                    for (int qwe = 0; qwe < size1; qwe++) {
                        for (int qwert = 0; qwert < size2; qwert++) {
                            ...
                            ad = distance_between_points(
                                    geo->poligon[number_poligon2].points[qwe + 1], geo->poligon[number_poligon].points[qwert + 1]);
                            ...
                            bd = distance_between_points(
                                    geo->poligon[number_poligon].points[qwert + 1], geo->poligon[number_poligon2].points[qwe + 1]);
                            if (!((aa < ar && ab < ar && ac < ar && ad < ar) || (ba < br && bb < br && bc < br && bd < br))) {
                                error++;
                            }
                        }

...
int main()
{
	...
	for (j = 1; j < geo->serial_number; j++) {
		if (j == geo->circle[number_circle].serial_number) {
			printf("%ld.  circle(%d %d, %.3f)\n\n", geo->circle[number_circle].serial_number, geo->circle[number_circle].point.x, geo->circle[number_circle].point.y, geo->circle[number_circle].radius);
			number_circle++;
			continue;
		}
		...
		geo->triangle[number_triangle].point[0].x, geo->triangle[number_triangle].point[0].y,
		geo->triangle[number_triangle].point[1].x, geo->triangle[number_triangle].point[1].y,
		geo->triangle[number_triangle].point[2].x, geo->triangle[number_triangle].point[2].y,
		geo->triangle[number_triangle].point[3].x, geo->triangle[number_triangle].point[3].y);
			number_triangle++;
			continue;
		}
	...
	printf("%d %d\n", geo->poligon[0].points[0].x, geo->poligon[2].points[6].y);*/
